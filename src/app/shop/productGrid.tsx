					...
					{products.map((p) => (
						...
						>
							...
							<div className="mt-auto flex gap-2">
								<button
									className="px-4 py-2 rounded bg-[#456882] text-white font-semibold hover:bg-[#234052] transition"
									onClick={() => alert(`Added ${p.name} to cart!`)}
								>
									Add to Cart
								</button>
								<button
									className="px-4 py-2 rounded bg-[#F9F3EF] text-[#456882] font-semibold border border-[#456882] hover:bg-[#456882] hover:text-white transition"
